  ...
  return (
     <div className="w-full min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl bg-white rounded-lg shadow-md p-6 space-y-4 border border-gray-200">
        ...
        <h1 className="Heading text-xl font-semibold text-gray-800 mx-2 text-center ">Edit Post</h1>

        </div>


        <div>
            <input className='w-full p-3 border rounded-md resize-none focus:outline-none focus:ring-2 focus:ring-blue-400 mb-4' type="text" placeholder='Heading'/>
          <textarea
        ...
        <button
            title="Add Image"
            className="p-2 rounded hover:bg-gray-100 transition duration-150"
        >
