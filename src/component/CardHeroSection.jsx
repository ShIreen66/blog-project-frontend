  ...
  return (
    <div className="card h-100 w-[30%]  rounded-xl overflow-hidden shadow-sm">
          ...
          <div className="w-full h-15  mt-2 flex  gap-2 items-center justify-between px-3">
            ...
            <button className="text-sm font-medium bg-violet-300 px-3 py-2 rounded">Follow</button>
            {/* <button className="text-sm font-medium border-violet-300 border-2 px-3 py-2 rounded">unfollow</button> */}
          </div>
        </div>
  )
}
