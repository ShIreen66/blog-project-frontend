  ...
  return (
    ...
    <section className="w-full bg-violet-50 py-30 px-40 flex flex-col-reverse md:flex-row items-center justify-between">
      ...
      <div className="w-1/2">
        ...
        <p className="text-gray-700 text-lg mb-4 transition-transform duration-300 hover:-translate-y-1">
        ...
        <p className="text-gray-700 text-lg mb-6 transition-transform duration-300 hover:-translate-y-1">
